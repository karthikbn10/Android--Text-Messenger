...
public class ClockActivity extends View {
    ...
    public ClockActivity(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }

    public ClockActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }

    public ClockActivity(Context context) {
        super(context);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }
    ...
    public void init(Context context, @DrawableRes int watchFace, @DrawableRes int hourHand, @DrawableRes int minuteHand, int alpha, boolean is24, boolean hourOnTop) {
        ...
        ClockActivity.hourOnTop = hourOnTop;
        setFace(watchFace);
